...
**Status:** v0.31.0 (pre-1.0, minor bump per mechanism) · 1,478 test functions · **built for Antigravity — works with Claude Code and Codex** · Apache-2.0
...
└── tests/             # 1,478 acceptance-oriented determinism & security test functions
```
...
```bash
pip install -e '.[dev]'
pytest        # 1,478 test functions: determinism, budgets, hook contract, escapes
```
