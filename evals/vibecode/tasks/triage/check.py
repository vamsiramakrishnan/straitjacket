...
Two graders, one per phase of the iterative task:
...
Phase 2 deliberately re-checks the phase-1 behaviours that the amendment does
NOT contradict (seed data, visible count, chip contract, hash sharing), so a
build that satisfies the reshape by throwing the app away still has to bring
