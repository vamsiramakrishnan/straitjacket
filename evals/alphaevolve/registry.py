...
EXPERIMENT_MODULES: dict[str, str] = {
    ...
    "archive-policy": "evals.alphaevolve.archive_policy.evaluate",
...
LEVERS: tuple[LeverSpec, ...] = (
    ...
    _lever("cold-context-archive", "archive-policy", "context", "high", "adversarial", "offline", "src/ctx/context_archive_policy.py:choose_archive_tier", "choose_archive_tier(state, options)"),
    ...
    _lever("recovery-escalation", "escalation-policy", "orchestration", "high", "actual-usage", "canary", "src/ctx/recovery_policy.py:choose_recovery;src/ctx/steward.py:decide", "choose_recovery(state)"),
